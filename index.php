<?php
/**
 * index.php — public home page for Barangay Paule 1.
 */
...
require __DIR__ . '/frontend/partials/public_top.php';
?>
...
<?php require __DIR__ . '/frontend/partials/public_bottom.php'; ?>
