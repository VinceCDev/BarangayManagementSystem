...
<head>
    ...
    <title><?php echo e($page_title); ?> · Barangay Paule 1</title>
    <link rel="icon" href="<?php echo asset('images/logo1.png'); ?>" type="image/png">
...
<div class="auth-shell <?php echo e($shell_class); ?>">

    <aside class="auth-visual">
        <img class="auth-visual__img" src="<?php echo asset('images/h3.jpeg'); ?>" alt="Barangay Paule 1">
        <div class="auth-visual__top">
            <span class="auth-visual__logo">
                <img src="<?php echo asset('images/logo1.png'); ?>" alt="">Barangay Paule 1
            </span>
            <a class="auth-visual__back" href="<?php echo home_url(); ?>">
                Back to website <i class="bi bi-arrow-up-right"></i>
            </a>
        </div>
        <div class="auth-visual__caption">
            <h3 id="authCaption"><?php echo e($visual_lines[0]); ?></h3>
            <div class="auth-visual__dots" id="authDots">
                <?php foreach ($visual_lines as $i => $_) { ?>
                    <span class="<?php echo $i === 0 ? 'on' : ''; ?>"></span>
                <?php } ?>
            </div>
        </div>
    </aside>
    ...
    <main class="auth-form">
        <img src="<?php echo asset('images/logo1.png'); ?>" alt="" class="auth-form__logo">
