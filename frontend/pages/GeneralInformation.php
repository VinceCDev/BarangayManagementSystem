...
<head> 
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/GeneralInformation.css">
</head> 
<body>
    <header class="header"> 
        <a href="#" class="logo"> 
    ...
    <section id="introduction" class="introduction">
        <div class="picture1"> 
            <img src="/BarangayManagementSystem-main/frontend/assets/images/h3.jpeg" alt="Your Picture"> 
        </div> 
        <div class="hc1"> 
            <?php
