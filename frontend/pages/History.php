...
<head> 
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/History.css">
...
<body class="public">
    ...
    <section id="history" class="history">
        <div class="picture1"> 
            <img src="/BarangayManagementSystem-main/frontend/assets/images/history.jpg" alt="Your Picture"> 
        </div> 
        <div class="hc1">
            <?php
