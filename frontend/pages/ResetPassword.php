...
<head>
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/ResetPassword.css">
    ...
    <section>
      ...
      <div class="contentBx">
        <div class="formBx">
          ...
          <form method="post" action="/BarangayManagementSystem-main/backend/actions/update_password.php">
            <div class="inputBx">
