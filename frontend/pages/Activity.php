...
<head>
  ...
  <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/Activity.css">
</head>
<body>
  <div>
        ...
        <tbody id="activityTableBody">
            ...
            if ($resultActivities->num_rows > 0) {
                while ($row = $resultActivities->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><img src='/BarangayManagementSystem-main/upload/activity_photos/".$row['photos']."' alt='Photo' style='max-width: 70px; max-height: 70px; border-radius:50%'></td>";
                    echo "<td>" . $row["date"] . "</td>";
...
<div class="form-container" id="activityContainer">
  ...
  <form action="/BarangayManagementSystem-main/backend/actions/activity_insert.php" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-6">
...
<div class="form-container" id="editActivityForm">
    ...
    <form action="/BarangayManagementSystem-main/backend/actions/activity_update.php" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xhttp.open("GET", "/BarangayManagementSystem-main/backend/actions/activity_delete.php?id=" + activityId, true);
      xhttp.send();
