...
<head> 
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/Proof of Identity.css">
...
<body>
    <section class="contact">
        ...
        <form id="personalDataForm" action="/BarangayManagementSystem-main/backend/actions/proof_insert.php" method="post" enctype="multipart/form-data">
    ...
    <script>
        ...
        function submitFormData() {
            ...
            xhr.open('POST', '/BarangayManagementSystem-main/backend/actions/proof_insert.php', true);
            xhr.onload = function() {
                if (xhr.status === 200) {
    ...
    <script src="/BarangayManagementSystem-main/frontend/assets/js/map.js"></script>
