...
<head>
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/Contact.css">
...
<body>
    ...
    <form id="message-form" action="/BarangayManagementSystem-main/backend/actions/contact_insert.php" method="POST">
        <h3>Send Message</h3>
...
document.getElementById('message-form').addEventListener('submit', function(event) {
    ...
    fetch('/BarangayManagementSystem-main/backend/actions/contact_insert.php', {
        method: 'POST',
        body: formData
    })
