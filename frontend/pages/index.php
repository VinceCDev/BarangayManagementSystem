...
<body class="public">
    ...
    <section id="home" class="home"> 
        ...
        <div class="picture"> 
            <img src="/BarangayManagementSystem-main/frontend/assets/images/logo1.png" alt="Your Picture"> 
        </div> 
    </section> 
    <section id="about" class="about">
        <div class="picture1"> 
            <img src="/BarangayManagementSystem-main/frontend/assets/images/assembly.jpeg" alt="Your Picture"> 
        </div> 
        <div class="hc1"> 
                            ...
                            if (!$firstOfficialDisplayed) {
                                ...
                                <div class="col-md-12 d-flex justify-content-center">
                                    <div class="gallery-column" data-start="<?php echo $startOfTerm; ?>" data-end="<?php echo $endOfTerm; ?>">
                                        <div class="card">
                                            <img src="/BarangayManagementSystem-main/upload/photos/<?php echo $photo; ?>" class="card-img-top" alt="Photo">
                                            <div class="card-body">
