...
<head> 
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/Personal Data.css">
...
<body> 
    <section class="contact">
        ...
        <div class="container">
            ...
            <form id="personalDataForm" action="/BarangayManagementSystem-main/backend/actions/personal_data_insert.php" method="POST" onsubmit="return validateForm()">
    ...
    <script>
        function submitFormData() {
            ...
            if (isValid) {
                ...
                xhr.open('POST', '/BarangayManagementSystem-main/backend/actions/personal_data_insert.php', true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
