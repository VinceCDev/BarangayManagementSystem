...
<head>
  ...
  <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/UserProfile.css">
    ...
    <div>
      ...
      <div class="dashboard-box-container2">
        <div class="dashboard-box2">
          ...
          <form class="form2" id="form2" method="post" action="/BarangayManagementSystem-main/backend/actions/update_profile.php">
          ...
          <form class="form3" id="form3" method="post" action="/BarangayManagementSystem-main/backend/actions/update_profile.php">
...
function updateForms() {
    ...
    xhr.open("POST", "/BarangayManagementSystem-main/backend/actions/update_profile.php", true);
