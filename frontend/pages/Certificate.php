...
<head>
    ...
    <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/Certificate.css">
    <style>
        .modal-overlay {
            position: fixed;
            top: 0;
...
<body>
    ...
    <section class="certificate">
        ...
        <div class="box">
            ...
            <div class="button">
                <a id="view" href="/BarangayManagementSystem-main/upload/uploads/<?php echo $file; ?>" class="a2" target="_blank"><em>View</em></a>
    ...
    <div id="modalOverlay" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="requestForm" class="p-3" method="post" onsubmit="return handleSubmit(event)" action="/BarangayManagementSystem-main/backend/actions/services_submit.php">
