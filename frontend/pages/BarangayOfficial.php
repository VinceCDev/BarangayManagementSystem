...
<head>
  ...
  <link rel="stylesheet" href="/BarangayManagementSystem-main/frontend/assets/css/BarangayOfficial.css">
</head>
<body>
  <div>
    <div class="header">
...
<div class="barangay" id="barangayOfficialsDashboard">
        ...
        <tbody>
            ...
            if ($resultOfficials->num_rows > 0) {
                while ($row = $resultOfficials->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><img src='/BarangayManagementSystem-main/upload/photos/".$row['photo']."' alt='Photo' style='max-width: 70px; max-height: 70px; border-radius:50%'></td>";
  ...
  <div class="form-container" id="formContainer" style="height: 550px">
    ...
    <form action="/BarangayManagementSystem-main/backend/actions/barangay_official_insert.php" method="POST" id="officialForm" enctype="multipart/form-data">
  <div class="row">
    <div class="col-md-6">
...
<div class="form-container" id="editformContainer" style="height: 550px; display: none;">
    ...
    <form action="/BarangayManagementSystem-main/backend/actions/barangay_official_update.php" method="POST" id="officialForm" enctype="multipart/form-data">
...
function deleteOfficial(officialId) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xhttp.open("GET", "/BarangayManagementSystem-main/backend/actions/barangay_official_delete.php?id=" + officialId, true);
      xhttp.send();
