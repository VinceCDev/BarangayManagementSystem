...
require(__DIR__ . '/../lib/fpdi2/src/autoload.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        if ($templateResult->num_rows > 0) {
            ...
            $pdf = new FPDI();
            $pdf->AddPage();
            $pdf->setSourceFile(UPLOAD_PATH . '/uploads/' . $templateFile);
            ...
            $requestPdfFolder = UPLOAD_PATH . '/request_pdf/';
            $pdfFolder = UPLOAD_PATH . '/_dms_mirror/request_pdf/';
