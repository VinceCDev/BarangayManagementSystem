...
require(__DIR__ . '/../lib/fpdi2/src/autoload.php'); // Ensure the correct path to FPDI autoload
...
if (isset($_GET['id']) && isset($_GET['action'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($templateResult->num_rows > 0) {
            ...
            $pdf->setSourceFile(UPLOAD_PATH . '/uploads/' . $templateFile); // Use the file column from the database
