...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $target_dir = UPLOAD_PATH . "/resident_photo/";
    $target_file = $target_dir . basename($photo);

    // DMS directories for file storage
    $dms_target_dir = UPLOAD_PATH . "/_dms_mirror/resident_photo/";
    ...
    if (move_uploaded_file($tmp_name, $target_file)) {
        ...
        if ($resultUserData->num_rows == 1) {
            ...
            try {
                ...
                header("Location: /BarangayManagementSystem-main/frontend/pages/Resident.php");
                exit();
            } catch (Exception $e) {
